...
<form action="/adminProdutos/edit/{{$produto->id}}" method="POST"  enctype="multipart/form-data">
        @method("PUT") 
        @csrf
        {{-- NOME --}}
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control" name="valor" step="0.01" id="valor" placeholder="Preço" value="{{$produto->valor}}">
          </div>
        </div>
        {{-- Imagem --}}
        <div class="form-group row">
