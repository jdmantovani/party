                ...
                <div class=" collapse navbar-collapse  " id="conteudoNavbarSuportado">
                    <ul class="navbar-nav mr-auto"style="font-family: 'Montserrat',sans-serif;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu color-nav" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item font-nav" href="{{route('login')}}">
                            Login</a>
      ...
      <div class="login-form ">
            <div class=" container ">
                <form class="box " action="index.html" method="post">
                  <div class=" title-login-form"><a href="index.html"><img src="img/Logo_pet_party.png" style="width: 80px;"  alt="" title=""></a><br> Seja Bem Vindo</div>
