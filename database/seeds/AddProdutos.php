...
class AddProdutos extends Seeder
{
    ...
    public function run()
    {
        Produtos::create([
            ...
            'valor' => 80,
            'url' => '/storage/uploads/caixatransportadora.jpg'
            ]);
        Produtos::create([
            'nome' => 'Jogo de Colchões',
            'descricao' => 'Jogo de Colchões para Cachorro',
            'valor' => 80,
            'url' => '/storage/uploads/jogocolchoes.jpg'
        ...
        Produtos::create([
            ...
            'valor' => 80,
            'url' => '/storage/uploads/capachuva.jpg'

            ]);
        Produtos::create([
            'nome' => 'Arranhador',
            'descricao' => 'Arranhador para gato',
            'valor' => 80,
            'url' => '/storage/uploads/arranhador.jpg'
        ...
        Produtos::create([
            ...
            'valor' => 80,
            'url' => '/storage/uploads/jogocolchoesgato.jpg'
        ...
        Produtos::create([
            ...
            'valor' => 80,
            'url' => '/storage/uploads/caixatransportegato.jpg'
        ...
        Produtos::create([
            ...
            'valor' => 15,
            'url' => '/storage/uploads/varinha.jpeg'
            ]);
        Produtos::create([
